...
export default function getLightModeColorScheme(colorPalette: KrPalette) {
  const {
    primary,
    primaryBlack,
    primaryBlackLight,
  ...
  const lightPalette = getPalette(colorPalette, lightKrColor)

  return { lightKrColor, lightPalette }
}
