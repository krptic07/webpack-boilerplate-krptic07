...
export default function getDarkModeColorScheme(colorPalette: KrPalette) {
  const {
    primary,
    primaryBlack,
    primaryBlackLight,
  ...
  const darkPalette = getPalette(colorPalette, darkKrColor)

  return { darkKrColor, darkPalette }
}
